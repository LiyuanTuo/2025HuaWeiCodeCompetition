...
// 传输时间范围是[10, 20]
int N, g[11], k[11], m[11], M, latency[11][501], a, b, server_index[501][11], request_size[11], request_id, delay_parameter[501], size_parameter[501];
short NPU_size[11][11][300001];              // 有极端数据，13.5万是安全的
vector<int> receive_process[11][11][300001]; // 内存储请求的id
...
void solution()
{
    for (int i = 1; i <= M; i++)
    {
        ...
        // cerr << Fast_Solu.back().process_start << "\n";
    }
